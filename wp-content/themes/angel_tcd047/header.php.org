...
<?php } ?>
 ...
 <div id="header_slider_wrap" class="clearfix<?php if($options['index_slider_type'] == 'type2') { echo ' type2'; }; if($options['show_index_banner_content'] == 1) { echo ' has_banner_content'; } else { echo ' no_banner_content'; }; ?>">
  <div id="header_slider">
   ...
   ?>
   <div style="background:url(<?php if(!empty($image)) { echo esc_attr($image[0]); } else { echo $no_image; }; ?>) no-repeat center center; background-size:cover;" class="item item<?php echo $i; ?>" class="item item<?php echo $i; ?>">
    <div class="caption">
