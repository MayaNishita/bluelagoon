...
add_page_builder_widget(array(
	...
	'form_rightbar' => 'form_rightbar_page_builder_widget_headline',
...
<div class="form-field form-field-jscolor">
	...
	<input type="text" id="pb_headline_font_color-<?php echo esc_attr($values['widget_index']); ?>" name="pagebuilder[widget][<?php echo esc_attr($values['widget_index']); ?>][font_color]" value="<?php echo esc_attr($values['font_color']); ?>" class="pb-input-narrow pb-color" />
	<input type="button" value="<?php _e('Default color', 'tcd-w'); ?>" class="button" style="margin:0 0 0 5px;" onClick="document.getElementById('pb_headline_font_color-<?php echo esc_attr($values['widget_index']); ?>').color.fromString('<?php echo esc_attr($default_values['font_color']); ?>')">
</div>
 ...
 * フォーム 右サイドバー
 */
function form_rightbar_page_builder_widget_headline($values = array()) {
	// デフォルト値
	$default_values = apply_filters('page_builder_widget_headline_default_values', array(
		'widget_index' => '',
		'margin_bottom' => 30,
