...
?>
 <li class="clearfix">
   <?php if($show_image1) { if ( has_post_thumbnail()) { ?><a class="image" href="<?php the_permalink() ?>"><?php the_post_thumbnail('size1'); ?></a><?php }; }; ?>
   <div class="info">
    <?php if($show_date1) { ?><p class="date"><?php the_time('Y.m.j'); ?></p><?php }; ?>
    <a class="title" href="<?php the_permalink() ?>"><?php trim_title(28); ?></a>
   </div>
 </li>
...
?>
 <li class="clearfix">
   <?php if($show_image2) { if ( has_post_thumbnail()) { ?><a class="image" href="<?php the_permalink() ?>"><?php the_post_thumbnail('size1'); ?></a><?php }; }; ?>
   <div class="info">
...
// End class widget
add_action('widgets_init', create_function('', 'return register_widget("tab_post_list_widget");'));
