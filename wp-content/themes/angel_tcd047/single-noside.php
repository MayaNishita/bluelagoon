<?php
/*
Single Post Template: 投稿（サイドメニューなし）
*/
...
<?php echo '<div class="epicad-wide"><ul><li>'.adrotate_group(1).'</li><li>'.adrotate_group(2).'</li></ul></div>'; ?>
  ...
  ?>
  <div class="no-sidemenu"><div id="related_post">
...
<?php echo '<div class="epicad-wide" style="margin-top:50px;"><ul><li>'.adrotate_group(7).'</li><li>'.adrotate_group(8).'</li></ul></div>'; ?>
