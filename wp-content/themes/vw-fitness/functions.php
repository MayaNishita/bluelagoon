...
define('VW_FITNESS_FREE_THEME_DOC','https://vwthemes.net/docs/free-vw-fitness/','vw-fitness');
define('VW_FITNESS_SUPPORT','https://www.vwthemes.com/support/vw-theme/','vw-fitness');
...
define('VW_FITNESS_LIVE_DEMO','https://www.vwthemes.net/vw-fitness-theme/','vw-fitness');
define('VW_FITNESS_PRO_DOC','https://www.vwthemes.com/docs/vw-fitness/','vw-fitness');
