...
function vw_education_lite_activation_notice() {
	echo '<div class="notice notice-success is-dismissible">';
		...
		echo '<p><a href="'. esc_url( admin_url( 'themes.php?page=vw_education_lite_guide' ) ) .'" class="button button-primary">'. esc_html__( 'Welcome Page', 'vw-education-lite' ) .'</a></p>';
	echo '</div>';
}
...
define('vw_education_lite_FREE_THEME_DOC','https://vwthemes.net/docs/vw-education-lite/','vw-education-lite');
define('vw_education_lite_SUPPORT','https://www.vwthemes.com/support/vw-theme/','vw-education-lite');
...
if ( ! function_exists( 'vw_education_lite_credit' ) ) {
	function vw_education_lite_credit(){
			echo "<a href=".esc_url(vw_education_lite_CREDIT)." target='_blank'>".esc_html('VWThemes','vw-education-lite')."</a>";
	}
}
