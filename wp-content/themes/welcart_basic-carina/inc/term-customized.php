...
<div class="form-field wcct-image-uploader new-form-field">
	<label for="wcct-tag-thumbnail"><?php _e( 'Category image', 'welcart_basic_carina' ); ?></label>
...
<tr class="form-field wcct-image-uploader edit-form-field">
	<th scope="row" valign="top"><label for="wcct-tag-thumbnail"><?php _e( 'Category image', 'welcart_basic_carina' ); ?></label></th>
	<td>
		<p class="thumbnail-form">
...
jQuery(function($) {
	...
	$('#wcct-tag-thumbnail-action').live('click', function(e){
		...
		file_frame = wp.media.frames.file_frame = wp.media({
			title: '<?php _e( 'Category image', 'welcart_basic_carina' ); ?>',
			library: {
				type: 'image',
				author: userSettings.uid
			},
			button: {
				text: '<?php _e( 'Set the category image', 'welcart_basic_carina' ); ?>',
				close: true
			},
			multiple: false
		});
