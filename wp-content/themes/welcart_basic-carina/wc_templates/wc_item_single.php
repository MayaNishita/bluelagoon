...
<div id="primary" class="site-content">
			...
			<?php usces_have_skus(); ?>
				...
				<div id="itempage">
					...
					<div class="item-info">
						...
						do {
						?>
							<div class="skuform<?php echo 1 == usces_sku_num() ? ' single-sku' : ' multiple-sku'; ?>">
								...
								<?php if( !usces_have_zaiko() ) : ?>
									...
									<div class="contact-item"><a href="<?php echo wcct_get_inquiry_link_url(); ?>"><i class="fa fa-envelope"></i><?php _e('Inquiries regarding this item' , 'welcart_basic_carina'); ?></a></div>
									<?php else: ?>
					...
					<div id="tab">
						...
						<ul class="tab-list cf">
							<li><span class="tab_link"><?php _e('Product Details', 'welcart_basic_carina'); ?></span></li>
							<?php if(wcct_get_options('review')): ?>
							<li><span class="tab_link"><?php _e('Review', 'welcart_basic_carina'); ?><span class="review-num">（ <?php echo get_comments_number(); ?> ）</span></span></li>
							<?php endif; ?>
						</ul>
						</div>
	...
	<?php if ( is_active_sidebar('nova-itempage')): ?>
		<div id="itempage-widget" class="widget-area">
			<?php dynamic_sidebar( 'nova-itempage' ); ?>
		</div><!-- #itmepage-widget -->
	<?php endif; ?>
