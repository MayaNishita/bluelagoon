						...
						<form action="<?php echo USCES_CART_URL; ?>" method="post">
							...
							<div id="skuform" class="skuform">
								...
								<div id="checkout_box">
									...
									<div class="contact-item inquiry"><a href="<?php echo wcct_get_inquiry_link_url(); ?>"><i class="fa fa-envelope"></i><?php _e('Inquiries regarding this item' , 'welcart_basic_carina'); ?></a></div>
									<?php else: ?>
