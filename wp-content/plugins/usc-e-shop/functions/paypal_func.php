...
function usces_paypal_purchase_form() {
	...
	$html = '
			...
			$html .= '<div class="send"><input type="image" src="'.$checkout_button.'" border="0" name="submit" value="submit" width="100%" alt="PayPal"'.apply_filters( 'usces_filter_confirm_nextbutton', NULL ).$purchase_disabled.' /></div>';
...
function usces_paypal_checkout_button() {
	$checkout_button = ( USCES_JP ) ? "https://www.paypalobjects.com/digitalassets/c/website/marketing/apac/jp/developer/pay_button_228_50.png" : "https://www.paypal.com/en_US/i/btn/btn_buynowCC_LG.gif";
