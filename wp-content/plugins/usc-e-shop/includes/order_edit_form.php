...
//	}
	...
	$("input[name*='update_order_edit']").click(function(){
...
<div id="addItemDialog" title="<?php _e('Add item', 'usces'); ?>">
	...
	<?php
		...
		$dropdown_options = array( 'show_option_none' => __('Select a category', 'usces'), 'name' => 'newitemcategory', 'id' => 'newitemcategory', 'hide_empty' => 1, 'hierarchical' => 1, 'orderby' => 'name', 'child_of' => $idObj->term_id );
