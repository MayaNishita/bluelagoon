...
<div id="uscestabs" class="usces_settlement" style="display:none;">
	...
	<ul>
		<li><a href="#uscestabs_settlement_top"><?php _e('クレジット決済モジュール選択','usces'); ?></a></li>
	...
	<form action="" method="post" id="settlement_top_form">
		<div class="settlement-left">
			<h2><?php _e('利用できるクレジット決済モジュール', 'usces'); ?></h2>
			<div class="settlement-description">
				<p class="description"><?php _e('利用したいクレジット決済モジュールを右側にドラッグしてください。<br />ドラッグ後は必ず「利用するモジュールを更新する」ボタンをクリックしてください。', 'usces'); ?></p>
			</div>
...
9:00～20:00（年中無休）</p>
	...
	<div class="settle_exp">
		...
		<p>PayPalウェブペイメントプラス決済サービスの利用には、ペイパルビジネスアカウントが必要です。ビジネスアカウントの開設は<a href="https://ad.doubleclick.net/ddm/clk/411330212;212055394;j" target="_blank">こちら</a></p>
		<p>ビジネスアカウントの開設手順は<a href="https://www.paypal.com/jp/webapps/mpp/merchant/how-to-signup-business" target="_blank">こちら</a>をご覧ください。</p>
		<p><a href="https://www.paypal.com/jp/webapps/mpp/support/kyc-corp" target="_blank">ビジネスアカウントの本人確認書類の提出について</a></p>
		<p>ウェブペイメントプラスのご利用には審査が必要です。審査については<a href="https://www.paypal.com/jp/webapps/mpp/developer/standard-service/wpp/how-to-start" target="_blank">こちら</a></p>
