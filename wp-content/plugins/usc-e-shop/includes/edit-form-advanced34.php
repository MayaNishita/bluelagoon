...
$itemOrderAcceptable = get_post_meta( $post_ID, '_itemOrderAcceptable', true );
$itemOrderAcceptable_checked = ( !empty($itemOrderAcceptable) && $itemOrderAcceptable == 1 ) ? ' checked="checked"' : '';
...
<tr>
<th><?php _e('Purchase restriction when sold out', 'usces'); ?></th>
<td><label type="itemOrderAcceptable"><input name="itemOrderAcceptable" type="checkbox" id="itemOrderAcceptable" class="itemOrderAcceptable" value="1"<?php echo $itemOrderAcceptable_checked; ?>/><?php _e('Purchase is not restricted (not checked the stock) even when sold out.','usces'); ?></label></td>
